...
class Solution
{
    ...
    pair<bool,int> issumfast(Node *root){
        ...
        pair<bool,int> left1=issumfast(root->left);
        pair<bool,int>right1=issumfast(root->right);
        int leftans=left1.first;
        int rightans=right1.first;
        bool ans;
